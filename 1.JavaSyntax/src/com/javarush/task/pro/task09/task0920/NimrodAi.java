...
public class NimrodAi {
    ...
    public static void main(String[] args) {
        String names[] = {"diningRoom", "o2", "medRoom", "armoury", "securityRoom", "reactor", "telecom", "warehouse", "controlRoom", "powerRoom"};
        for (String Name : names ) {
            if (checkPirates(Name)) {
                openFloodgates(Name);
            }
        }
    }
    ...
    public static String[] getRoomByName(String roomName) {
        ...
        if (roomName.equals("o2")) {
            return o2;
        }
        if (roomName.equals("medRoom")) {
            return medRoom;
        }
        if (roomName.equals("armoury")) {
            return armoury;
        }
        if (roomName.equals("securityRoom")) {
            return securityRoom;
        }
        if (roomName.equals("reactor")) {
            return reactor;
        }
        if (roomName.equals("telecom")) {
            return telecom;
        }
        if (roomName.equals("warehouse")) {
            return warehouse;
        }
        if (roomName.equals("controlRoom")) {
            return controlRoom;
        }
        if (roomName.equals("powerRoom")) {
            return powerRoom;
        } else {
            return null;
        }

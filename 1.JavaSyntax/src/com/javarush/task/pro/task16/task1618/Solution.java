...
public class Solution {
    ...
    static LocalDateTime changeZone(LocalDateTime fromDateTime, ZoneId fromZone, ZoneId toZone) {
        long oneZoneHour = ZonedDateTime.now(fromZone).getHour();
        long twoZoneHour = ZonedDateTime.now(toZone).getHour();
        long dif = oneZoneHour - twoZoneHour;

        return fromDateTime.minusHours(dif);
    }
}
